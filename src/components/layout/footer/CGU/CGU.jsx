...
const CGU = () => {
    return (
        <div className="content-block-lct">
            <h3>Conditions générales d'utilisation du site
                <span className="txt_modifiable">[URL]</span></h3>
            <p className="h4">ARTICLE
        1&nbsp;: Objet</p>
            <p>
        Les présentes «&nbsp;conditions générales d'utilisation&nbsp;»
        ont pour objet l'encadrement juridique des modalités de mise à
        disposition des services du site <span className="txt_modifiable">[Nom du site]</span>
        ...
        renoncer à l'accès des services proposés par le site.</p>
            </li><li><p><span className="txt_modifiable">[Nom
        du site]</span> se réserve le droit de modifier unilatéralement et
        à tout moment le contenu des présentes conditions générales
        d'utilisation.</p>
            </li></ul><p className="h4">ARTICLE
        2&nbsp;: Mentions légales</p>
            <p>
        L'édition du site <span className="txt_modifiable">[Nom du site]</span> est
        assurée par la Société <span className="txt_modifiable">[Nom de la société]</span>
                <span className="txt_modifiable">[SAS / SA / SARL, etc.]</span> au capital de
                <span className="txt_modifiable">[montant en euros]</span>&nbsp;€ dont le
        siège social est situé au <span className="txt_modifiable">[adresse du siège
        social]</span>.</p>
            <p>
                <span className="txt_modifiable">[Le Directeur / La Directrice]</span> de la
        publication est <span className="txt_modifiable">[Madame / Monsieur]</span> <span className="txt_modifiable">[Nom
        &amp; Prénom]</span>.</p>
            <p>
        Éventuellement&nbsp;:</p>
            <ul><li><p>
                <span className="txt_modifiable">[Nom de la société]</span> est une société
        du groupe <span className="txt_modifiable">[Nom de la société]</span> <span className="txt_modifiable">[SAS
        / SA / SARL, etc.]</span> au capital de <span className="txt_modifiable">[montant
        en euros]</span>&nbsp;€ dont le siège social est situé au
                <span className="txt_modifiable">[adresse du siège social]</span>.</p>
            </li></ul><p>
        L'hébergeur du site <span className="txt_modifiable">[Nom du site]</span> est
        la Société <span className="txt_modifiable">[Nom de la société]</span> <span className="txt_modifiable">[SAS
        / SA / SARL, etc.]</span> au capital de <span className="txt_modifiable">[montant
        en euros]</span>&nbsp;€ dont le siège social est situé au
                <span className="txt_modifiable">[adresse du siège social]</span>.</p>
            <p className="h4">ARTICLE&nbsp;3&nbsp;:
        Définitions</p>
            <p>
        ...
        confidentiel.</p>
            </li></ul><p className="h4">ARTICLE&nbsp;4&nbsp;:
        accès aux services</p>
            <p>
        Le site permet à l'Utilisateur un accès gratuit aux services
        suivants&nbsp;:</p>
            <ul><li><p>
                <span className="txt_modifiable">[articles d'information]</span>&nbsp;;</p>
            </li><li><p><span className="txt_modifiable">[annonces
        classées]</span>&nbsp;;</p>
            </li><li><p><span className="txt_modifiable">[mise
        en relation de personnes]</span>&nbsp;;</p>
            </li><li><p><span className="txt_modifiable">[publication
        de commentaires / d'œuvres personnelles]</span>&nbsp;;</p>
            </li><li><p>
                <span className="txt_modifiable">[…]</span>.</p>
            </li></ul><p>
        ...
        pas la responsabilité de <span className="txt_modifiable">[Nom du site]</span>.</p>
            <p>
        ...
        électronique à l'adresse <span className="txt_modifiable">[contact@nomdusite.com]</span>.
            </p>
            <p className="h4">ARTICLE&nbsp;5&nbsp;:
        ...
        à la CNIL sous le numéro <span className="txt_modifiable">[numéro]</span>.</p>
            <p>
        En vertu des articles 48 et suivants de la loi n° 78-17 relative à l'informatique, aux fichiers et aux libertés en date du 6&nbsp;janvier 1978, réécrite par l'ordonnance n° 2018-1125 du 12 décembre 2018 applicable au 1er juin 2019,
        ...
        formulaire de contact&nbsp;;</p>
                ...
                <span className="txt_modifiable">[adresse mail]</span>&nbsp;;</p>
            </li><li><p>par voie
        postale au <span className="txt_modifiable">[adresse]</span>.</p>
            </li></ul><p className="h4">ARTICLE&nbsp;7&nbsp;:
        ...
        responsabilité de <span className="txt_modifiable">[Nom du site]</span> qui n'a
        ...
        seuls les tribunaux <span className="txt_modifiable">[du ressort de la Cour
        d'appel de / de la ville de]</span> <span className="txt_modifiable">[Ville]</span>
        sont compétents.</p>
            <p>
        Éventuellement</p>
            <p className="h4">ARTICLE&nbsp;12&nbsp;:
        Publication par l'Utilisateur</p>
            <p>
        Le site permet aux membres de publier <span className="txt_modifiable">[des
        commentaires / des œuvres personnelles]</span>.</p>
            <p>
        Dans ses publications, le membre s'engage à respecter les règles
        de la Netiquette et les règles de droit en vigueur.</p>
            <p>
        Le site exerce une modération <span className="txt_modifiable">[a priori / a
        posteriori]</span> sur les publications et se réserve le droit de
